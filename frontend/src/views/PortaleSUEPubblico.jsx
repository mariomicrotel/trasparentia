...
// Pagina STANDALONE, raggiungibile su /sportello-sue SENZA login: il
// presentatore (cittadino/tecnico) non ha e non deve avere credenziali di
// staff. Bypassa interamente l'autenticazione interna (nativa/Keycloak) —
// vedi il check in App.jsx (e in main.jsx per il caso Keycloak).
//
// Nel sistema reale l'identità sarebbe SPID/CIE: qui, da prototipo, il
// presentatore la dichiara nel form (mock esplicito, coerente con la scelta
// "prototipo" fatta per questo sportello).
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-page, #f5f6fa)", fontFamily: "Titillium Web, sans-serif" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "28px 20px 60px" }}>
        <div className="banner banner--info" style={{ marginBottom: 20, fontSize: 13 }}>
          ...
          <span>
            Prototipo dimostrativo: l'identità SPID/CIE, la firma digitale e il Catalogo nazionale degli Sportelli Unici sono simulati.
            Compila i tuoi dati e il modulo per presentare l'istanza.
          </span>
        </div>

        <Presenta toast={toast} />
      </div>
